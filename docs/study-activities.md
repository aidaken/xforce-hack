...
Charlotte's standalone HTML prototype and three reusable activities. These are kept separate from ADDY's main app; this commit does not wire them into the live reading flow.
